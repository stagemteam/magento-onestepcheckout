...
(function ($) {
    $.widget('mage.regionUpdater', {
        ...
        _updateRegion: function (country) {
            ...
            if (this.options.regionJson[country]) {
                ...
                if (this.options.isRegionRequired) {
                    ...
                    regionInput.parent().show();
                    regionInput.parent().parent().show();
                    ...
                    if (!this.options.optionalRegionAllowed) {
                        ...
                        //regionList.hide();
                        regionList.parent().hide();
                        regionInput.parent().parent().hide();
                ...
                if (this.options.isRegionRequired) {
                    ...
                    if (!this.options.optionalRegionAllowed) {
                        ...
                        regionInput.parent().hide();
                        regionInput.parent().parent().hide();

                    }
                }
                regionList.attr('disabled', 'disabled');
                regionList.removeClass('required-entry validate-select').hide();
                regionInput.show();
                requiredLabel.removeClass('required');
        ...
        _checkRegionRequired: function (country) {
            ...
            var self = this;
            if(this.options.regionJson.config){
